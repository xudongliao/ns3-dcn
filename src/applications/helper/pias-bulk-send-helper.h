#ifndef PIAS_BULK_SEND_HELPER_H
#define PIAS_BULK_SEND_HELPER_H
 ...
 * on a set of nodes.
 */
class PiasBulkSendHelper
{
public:
  /**
   * Create an PiasBulkSendHelper to make it easier to work with BulkSendApplications
   *
   ...
   *        to.
   */
  PiasBulkSendHelper (std::string protocol, Address address);
