...
#ifndef PFABRIC_BULK_SEND_HELPER_H
#define PFABRIC_BULK_SEND_HELPER_H
 ...
 * on a set of nodes.
 */
class PfabricBulkSendHelper
{
public:
  /**
   * Create an PfabricBulkSendHelper to make it easier to work with BulkSendApplications
   *
   ...
   *        to.
   */
  PfabricBulkSendHelper (std::string protocol, Address address);
