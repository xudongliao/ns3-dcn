...
#ifndef PFABRIC_BULK_SEND_APPLICATION_H
#define PFABRIC_BULK_SEND_APPLICATION_H
 ...
 * \defgroup bulksend PfabricBulkSendApplication
 *
 ...
 *
 */
class PfabricBulkSendApplication : public Application
{
public:
  /**
  ...
  PfabricBulkSendApplication ();

  virtual ~PfabricBulkSendApplication ();
